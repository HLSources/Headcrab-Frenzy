...
int __MsgFunc_EndGame(const char *pszName, int iSize, void *pbuf )
{
	return gHUD.MsgFunc_EndGame( pszName, iSize, pbuf );
}

int __MsgFunc_RestartGame(const char *pszName, int iSize, void *pbuf )
{
	return gHUD.MsgFunc_RestartGame( pszName, iSize, pbuf );
}
...
void CHud :: Init( void )
{
	...
	HOOK_MESSAGE( EndGame );
	HOOK_MESSAGE( RestartGame );
