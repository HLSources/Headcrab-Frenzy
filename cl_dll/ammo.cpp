...
void WeaponsResource :: SelectSlot( int iSlot, int fAdvance, int iDirection )
{
	...
	if ( gHUD.m_Poll.m_fMenuDisplayed && (fAdvance == FALSE) && (iDirection == 1) )	
	{ // poll is overriding slot use commands
		gHUD.m_Poll.SelectPollVote( iSlot + 1 );  // slots are one off the key numbers
		return;
	}
