...
#define HIDE_TEXTWINDOW_HCFSTART 5
#define HIDE_TEXTWINDOW_HCFSTART2 6
...
public:
	...
	virtual void actionPerformed(Panel* panel)
	{
		if (m_iState == HIDE_TEXTWINDOW_HCFSTART)
		{
			gViewPort->HideTopMenu();
			gEngfuncs.pfnClientCmd( "hcf_mode \"1\"\nhcf_restart\n" );
		}
		else if (m_iState == HIDE_TEXTWINDOW_HCFSTART2)
		{
			gViewPort->HideTopMenu();
			gEngfuncs.pfnClientCmd( "hcf_mode \"2\"\nhcf_restart\n" );
		}
		else if (m_iState == HIDE_TEXTWINDOW)
		{
			gViewPort->HideTopMenu();
		}
		else 
